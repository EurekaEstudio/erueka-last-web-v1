...
const Header = () => {
  ...
  return (
    <motion.header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-black/80 backdrop-blur-sm shadow-lg shadow-cyan-500/10' : 'bg-transparent'
        }`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      <div className="container mx-auto px-6 md:px-20 flex justify-between items-center h-24 md:h-32">
        ...
        <div className="flex-1 flex justify-end">
          <motion.button
            ...
            className="bg-cyan-400 text-black font-semibold text-sm md:text-base tracking-wider py-1.5 px-4 md:py-2 md:px-5 rounded-full transition-all duration-300"
